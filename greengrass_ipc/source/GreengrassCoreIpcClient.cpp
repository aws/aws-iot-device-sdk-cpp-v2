...
GreengrassCoreIpcClient::GreengrassCoreIpcClient(
  ...
  m_greengrassCoreIpcServiceModel.AssignModelNameToErrorResponse(
      Aws::Crt::String("aws.greengrass#InvalidTokenError"),
  ...
  m_greengrassCoreIpcServiceModel.AssignModelNameToErrorResponse(
      Aws::Crt::String("aws.greengrass#ConflictError"),
...
std::shared_ptr<SubscribeToIoTCoreOperation>
GreengrassCoreIpcClient::NewSubscribeToIoTCore(
  ...
  return Aws::Crt::MakeShared<SubscribeToIoTCoreOperation>(
      m_allocator, m_connection, std::move(streamHandler),
      m_greengrassCoreIpcServiceModel.m_subscribeToIoTCoreOperationContext,
      m_allocator);
}

std::shared_ptr<ResumeComponentOperation>
GreengrassCoreIpcClient::NewResumeComponent() noexcept {
  auto operation = Aws::Crt::MakeShared<ResumeComponentOperation>(
      m_allocator, m_connection,
...
std::shared_ptr<PublishToIoTCoreOperation>
GreengrassCoreIpcClient::NewPublishToIoTCore() noexcept {
...
std::shared_ptr<SubscribeToConfigurationUpdateOperation>
GreengrassCoreIpcClient::NewSubscribeToConfigurationUpdate(
  ...
  return Aws::Crt::MakeShared<SubscribeToConfigurationUpdateOperation>(
      m_allocator, m_connection, std::move(streamHandler),
      m_greengrassCoreIpcServiceModel
          .m_subscribeToConfigurationUpdateOperationContext,
      m_allocator);
}

std::shared_ptr<DeleteThingShadowOperation>
GreengrassCoreIpcClient::NewDeleteThingShadow() noexcept {
...
std::shared_ptr<PutComponentMetricOperation>
GreengrassCoreIpcClient::NewPutComponentMetric() noexcept {
...
std::shared_ptr<DeferComponentUpdateOperation>
GreengrassCoreIpcClient::NewDeferComponentUpdate() noexcept {
...
GreengrassCoreIpcClient::NewSubscribeToValidateConfigurationUpdates(
...
std::shared_ptr<GetConfigurationOperation>
GreengrassCoreIpcClient::NewGetConfiguration() noexcept {
...
std::shared_ptr<SubscribeToTopicOperation>
GreengrassCoreIpcClient::NewSubscribeToTopic(
...
std::shared_ptr<GetComponentDetailsOperation>
GreengrassCoreIpcClient::NewGetComponentDetails() noexcept {
...
std::shared_ptr<GetClientDeviceAuthTokenOperation>
GreengrassCoreIpcClient::NewGetClientDeviceAuthToken() noexcept {
...
std::shared_ptr<PublishToTopicOperation>
GreengrassCoreIpcClient::NewPublishToTopic() noexcept {
...
std::shared_ptr<SubscribeToCertificateUpdatesOperation>
GreengrassCoreIpcClient::NewSubscribeToCertificateUpdates(
    std::shared_ptr<SubscribeToCertificateUpdatesStreamHandler>
        streamHandler) noexcept {
...
std::shared_ptr<VerifyClientDeviceIdentityOperation>
GreengrassCoreIpcClient::NewVerifyClientDeviceIdentity() noexcept {
...
std::shared_ptr<AuthorizeClientDeviceActionOperation>
GreengrassCoreIpcClient::NewAuthorizeClientDeviceAction() noexcept {
...
std::shared_ptr<ListComponentsOperation>
GreengrassCoreIpcClient::NewListComponents() noexcept {
...
std::shared_ptr<CreateDebugPasswordOperation>
GreengrassCoreIpcClient::NewCreateDebugPassword() noexcept {
...
std::shared_ptr<GetThingShadowOperation>
GreengrassCoreIpcClient::NewGetThingShadow() noexcept {
...
std::shared_ptr<SendConfigurationValidityReportOperation>
GreengrassCoreIpcClient::NewSendConfigurationValidityReport() noexcept {
  auto operation =
      Aws::Crt::MakeShared<SendConfigurationValidityReportOperation>(
          m_allocator, m_connection,
          m_greengrassCoreIpcServiceModel
...
std::shared_ptr<UpdateThingShadowOperation>
GreengrassCoreIpcClient::NewUpdateThingShadow() noexcept {
...
std::shared_ptr<UpdateConfigurationOperation>
GreengrassCoreIpcClient::NewUpdateConfiguration() noexcept {
...
std::shared_ptr<ValidateAuthorizationTokenOperation>
GreengrassCoreIpcClient::NewValidateAuthorizationToken() noexcept {
...
std::shared_ptr<RestartComponentOperation>
GreengrassCoreIpcClient::NewRestartComponent() noexcept {
...
std::shared_ptr<GetLocalDeploymentStatusOperation>
GreengrassCoreIpcClient::NewGetLocalDeploymentStatus() noexcept {
...
std::shared_ptr<GetSecretValueOperation>
GreengrassCoreIpcClient::NewGetSecretValue() noexcept {
...
std::shared_ptr<UpdateStateOperation>
GreengrassCoreIpcClient::NewUpdateState() noexcept {
  auto operation = Aws::Crt::MakeShared<UpdateStateOperation>(
      m_allocator, m_connection,
      m_greengrassCoreIpcServiceModel.m_updateStateOperationContext,
      m_allocator);
  operation->WithLaunchMode(m_asyncLaunchMode);
  return operation;
}

std::shared_ptr<ListNamedShadowsForThingOperation>
GreengrassCoreIpcClient::NewListNamedShadowsForThing() noexcept {
...
std::shared_ptr<SubscribeToComponentUpdatesOperation>
GreengrassCoreIpcClient::NewSubscribeToComponentUpdates(
    std::shared_ptr<SubscribeToComponentUpdatesStreamHandler>
        streamHandler) noexcept {
...
std::shared_ptr<ListLocalDeploymentsOperation>
GreengrassCoreIpcClient::NewListLocalDeployments() noexcept {
...
std::shared_ptr<StopComponentOperation>
GreengrassCoreIpcClient::NewStopComponent() noexcept {
...
std::shared_ptr<PauseComponentOperation>
GreengrassCoreIpcClient::NewPauseComponent() noexcept {
...
std::shared_ptr<CreateLocalDeploymentOperation>
GreengrassCoreIpcClient::NewCreateLocalDeployment() noexcept {
