...
namespace Aws
{
    namespace Greengrass
    {
        ...
        void LocalDeploymentStatus::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
        {
            if (m_deploymentId.has_value())
            {
                payloadObject.WithString("deploymentId", m_deploymentId.value());
        ...
        void LocalDeploymentStatus::s_loadFromJsonView(
            LocalDeploymentStatus &localDeploymentStatus,
            const Aws::Crt::JsonView &jsonView) noexcept
        {
            if (jsonView.ValueExists("deploymentId"))
            {
                localDeploymentStatus.m_deploymentId =
                    Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("deploymentId"));
            }
            if (jsonView.ValueExists("status"))
            {
                localDeploymentStatus.m_status = Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("status"));
            }
            if (jsonView.ValueExists("createdOn"))
            {
                localDeploymentStatus.m_createdOn =
                    Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("createdOn"));
            }
            if (jsonView.ValueExists("deploymentStatusDetails"))
            {
                localDeploymentStatus.m_deploymentStatusDetails = DeploymentStatusDetails();
                DeploymentStatusDetails::s_loadFromJsonView(
                    localDeploymentStatus.m_deploymentStatusDetails.value(),
                    jsonView.GetJsonObject("deploymentStatusDetails"));
            }
        }

        void LocalDeploymentStatus::SetStatus(DeploymentStatus status) noexcept
        {
            switch (status)
            {
                case DEPLOYMENT_STATUS_QUEUED:
        ...
        Aws::Crt::Optional<DeploymentStatus> LocalDeploymentStatus::GetStatus() noexcept
        {
            if (!m_status.has_value())
                return Aws::Crt::Optional<DeploymentStatus>();
            if (m_status.value() == Aws::Crt::String("QUEUED"))
        ...
        const char *LocalDeploymentStatus::MODEL_NAME = "aws.greengrass#LocalDeploymentStatus";

        Aws::Crt::String LocalDeploymentStatus::GetModelName() const noexcept
        {
            return LocalDeploymentStatus::MODEL_NAME;
        }

        Aws::Crt::ScopedResource<AbstractShapeBase> LocalDeploymentStatus::s_allocateFromPayload(
            Aws::Crt::StringView stringView,
            Aws::Crt::Allocator *allocator) noexcept
        {
            Aws::Crt::String payload = {stringView.begin(), stringView.end()};
            ...
            Aws::Crt::ScopedResource<LocalDeploymentStatus> shape(
                Aws::Crt::New<LocalDeploymentStatus>(allocator), LocalDeploymentStatus::s_customDeleter);
            shape->m_allocator = allocator;
            LocalDeploymentStatus::s_loadFromJsonView(*shape, jsonView);
            auto operationResponse = static_cast<AbstractShapeBase *>(shape.release());
            return Aws::Crt::ScopedResource<AbstractShapeBase>(operationResponse, AbstractShapeBase::s_customDeleter);
        }

        void LocalDeploymentStatus::s_customDeleter(LocalDeploymentStatus *shape) noexcept
        {
            AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
        }
        ...
        void GetLocalDeploymentStatusResponse::SerializeToJsonObject(Aws::Crt::JsonObject &payloadObject) const noexcept
        {
            ...
            {
                Aws::Crt::JsonObject localDeploymentStatusValue;
                m_deployment.value().SerializeToJsonObject(localDeploymentStatusValue);
                payloadObject.WithObject("deployment", std::move(localDeploymentStatusValue));
            }
        }
            ...
            const Aws::Crt::JsonView &jsonView) noexcept
        {
            ...
            {
                getLocalDeploymentStatusResponse.m_deployment = LocalDeploymentStatus();
                LocalDeploymentStatus::s_loadFromJsonView(
