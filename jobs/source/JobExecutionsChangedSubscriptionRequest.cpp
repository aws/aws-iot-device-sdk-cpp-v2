...
namespace Iotjobs
{
    ...
    void JobExecutionsChangedSubscriptionRequest::LoadFromObject(JobExecutionsChangedSubscriptionRequest& val, const Aws::Crt::JsonView &doc)
    {
        (void)val;
        (void)doc;
    ...
    JobExecutionsChangedSubscriptionRequest& JobExecutionsChangedSubscriptionRequest::operator=(const Crt::JsonView& doc)
    {
