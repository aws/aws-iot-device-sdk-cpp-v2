    ...
    namespace Iotjobs
    {
        ...
        class AWS_IOTJOBS_API UpdateJobExecutionRequest final
        {
          public:
            ...
            /**
             * The new status for the job execution (IN_PROGRESS, FAILED, SUCCEEDED, or
            ...
            /**
             * A client token used to correlate requests and responses. Enter an arbitrary
             * value here and it is reflected in the response.
             *
             */
            ...
            /**
             * The expected current version of the job execution. Each time you update the
             * job execution, its version is incremented. If the version of the job
             * execution stored in the AWS IoT Jobs service does not match, the update is
             * rejected with a VersionMismatch error, and an ErrorResponse that contains
             * the current job execution status data is returned.
             *
             */
            ...
            /**
             * Optional. When included and set to true, the response contains the
             * JobDocument. The default is false.
             *
             */
             ...
             * UpdateJobExecution, setting the status to IN_PROGRESS and specifying a new
             * timeout value in this field) the job execution status is set to TIMED_OUT.
             * Setting or resetting this timeout has no effect on the job execution
             * timeout that might have been specified when the job was created (by using
             * CreateJob with the timeoutConfig).
             *
             */
