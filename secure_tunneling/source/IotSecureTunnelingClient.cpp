...
namespace Iotsecuretunneling
{
    ...
    IotSecureTunnelingClient::IotSecureTunnelingClient(const std::shared_ptr<Aws::Crt::Mqtt::MqttConnection>& connection) :
            m_connection(connection)
    {
    }

    IotSecureTunnelingClient::IotSecureTunnelingClient(const std::shared_ptr<Aws::Crt::Mqtt5::Mqtt5Client> &mqtt5Client)
    {
    ...
    bool IotSecureTunnelingClient::SubscribeToTunnelsNotify(const Aws::Iotsecuretunneling::SubscribeToTunnelsNotifyRequest& request, Aws::Crt::Mqtt::QOS qos,
                const OnSubscribeToTunnelsNotifyResponse& handler, const OnSubscribeComplete& onSubAck)
    {
        (void)request;
        ...
        subscribeTopicSStr  << "$aws"<< "/" << "things"<< "/" << *request.ThingName<< "/" << "tunnels"<< "/" << "notify";
