...
namespace Iotsecuretunneling
{
    ...
    /**
     * The AWS IoT Device Secure Tunneling service adds bidirectional communication to remote devices over a secure connection that is managed by AWS IoT.
     *
    ...
    class AWS_IOTSECURETUNNELING_API IotSecureTunnelingClient final
    {
      public:
         ...
         */
        bool SubscribeToTunnelsNotify(const Aws::Iotsecuretunneling::SubscribeToTunnelsNotifyRequest& request, Aws::Crt::Mqtt::QOS qos,
