...
namespace Aws
{
    namespace Iot
    {
        namespace ServiceTesting
        {
            ...
            inline std::shared_ptr<Aws::Crt::Mqtt5::Mqtt5Client> createProtocolClient5(Aws::Crt::Allocator *allocator)
            {
...

                {
                    ...
                    mqtt5Options.WithClientConnectionSuccessCallback([&lock, &signal, &connected](const Aws::Crt::Mqtt5::OnConnectionSuccessEventData &){
                        {
            ...
            inline std::shared_ptr<Aws::Crt::Mqtt::MqttConnection> createProtocolClient311(
                Aws::Crt::Allocator *allocator)
            {
...

                {
                    ...
                    connection->OnConnectionSuccess = [&connected, &lock, &signal](Aws::Crt::Mqtt::MqttConnection &connection, Aws::Crt::Mqtt::OnConnectionSuccessData *callbackData) {
                        {
                            std::lock_guard<std::mutex> guard(lock);
                            connected = true;
                        }
...
static std::shared_ptr<Aws::Iotshadow::IClientV2> s_createShadowClient5(Aws::Crt::Allocator *allocator)
{
...
static std::shared_ptr<Aws::Iotshadow::IClientV2> s_createShadowClient311(Aws::Crt::Allocator *allocator)
{
    auto protocolClient = Aws::Iot::ServiceTesting::createProtocolClient311(allocator);
    if (!protocolClient)
    {
        return nullptr;
    }
...
{
    {
        ...
        auto shadowClient = s_createShadowClient5(allocator);
        if (!shadowClient)
        {
            return AWS_OP_SKIP;
        }
...
{
    {
        ...
        auto shadowClient = s_createShadowClient311(allocator);
        if (!shadowClient)
        {
            return AWS_OP_SKIP;
        }
...
static int s_doGetNonexistentShadowTest(std::shared_ptr<Aws::Iotshadow::IClientV2> shadowClient)
{
    ...
    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::GetNamedShadowResult> getResult;
    ...
    shadowClient->GetNamedShadow(request, [&getResult](Aws::Iotshadow::GetNamedShadowResult &&result){
        getResult.ApplyResult(std::move(result));
    });
...
{
    Aws::Crt::ApiHandle handle;
    return s_doGetNonexistentShadowTest(s_createShadowClient5(allocator));
}
...
static int s_doCreateDestroyNamedShadowTest(std::shared_ptr<Aws::Iotshadow::IClientV2> shadowClient) {
    if (!shadowClient)
    {
        return AWS_OP_SKIP;
    }
    ...
    // 1. Create the Shadow
    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::UpdateNamedShadowResult> updateResultWaiter;
    ...
    shadowClient->UpdateNamedShadow(updateRequest, [&updateResultWaiter](Aws::Iotshadow::UpdateNamedShadowResult &&result){
    ...
    // 2. Delete the shadow
    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::DeleteNamedShadowResult> deleteResultWaiter;

    Aws::Iotshadow::DeleteNamedShadowRequest deleteRequest;
    deleteRequest.ShadowName = shadowName;
    deleteRequest.ThingName = thingName;

    shadowClient->DeleteNamedShadow(deleteRequest, [&deleteResultWaiter](Aws::Iotshadow::DeleteNamedShadowResult &&result){
...
{
    Aws::Crt::ApiHandle handle;
    return s_doCreateDestroyNamedShadowTest(s_createShadowClient5(allocator));
}
...
static std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> s_createNamedShadowUpdatedStream(std::shared_ptr<Aws::Iotshadow::IClientV2> shadowClient, Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::ShadowUpdatedEvent> &eventWaiter, const Aws::Crt::String &thingName, const Aws::Crt::String &shadowName) {
    ...
    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iot::RequestResponse::SubscriptionStatusEvent> subscribeWaiter;
    ...
    updateStreamOptions.WithSubscriptionStatusEventHandler([&subscribeWaiter](Aws::Iot::RequestResponse::SubscriptionStatusEvent &&event) {
...
static std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> s_createNamedShadowDeltaUpdatedStream(std::shared_ptr<Aws::Iotshadow::IClientV2> shadowClient, Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::ShadowDeltaUpdatedEvent> &eventWaiter, const Aws::Crt::String &thingName, const Aws::Crt::String &shadowName) {
    ...
    Aws::Iot::RequestResponse::StreamingOperationOptions<Aws::Iotshadow::ShadowDeltaUpdatedEvent> deltaUpdateStreamOptions;
    deltaUpdateStreamOptions.WithStreamHandler([&eventWaiter](Aws::Iotshadow::ShadowDeltaUpdatedEvent &&event){
        eventWaiter.ApplyResult(std::move(event));
    });
    deltaUpdateStreamOptions.WithSubscriptionStatusEventHandler([&subscribeWaiter](Aws::Iot::RequestResponse::SubscriptionStatusEvent &&event) {
        if (event.GetType() == Aws::Iot::RequestResponse::SubscriptionStatusEventType::SubscriptionEstablished) {
            subscribeWaiter.ApplyResult(std::move(event));
        }
    });

    auto deltaUpdateStream = shadowClient->CreateNamedShadowDeltaUpdatedStream(deltaUpdateStreamRequest, deltaUpdateStreamOptions);
...
static int s_doDeltaUpdateNamedShadowTest(std::shared_ptr<Aws::Iotshadow::IClientV2> shadowClient) {
    if (!shadowClient)
    {
        return AWS_OP_SKIP;
    }
    ...
    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::UpdateNamedShadowResult> createResultWaiter;
    ...
    shadowClient->UpdateNamedShadow(createRequest, [&createResultWaiter](Aws::Iotshadow::UpdateNamedShadowResult &&result){
    ...
    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::ShadowUpdatedEvent> updateStreamFirstEventWaiter;
    auto updateStream = s_createNamedShadowUpdatedStream(shadowClient, updateStreamFirstEventWaiter, thingName, shadowName);

    Aws::Iot::ServiceTesting::ResultWaiter<Aws::Iotshadow::ShadowDeltaUpdatedEvent> deltaUpdateStreamFirstEventWaiter;
    auto updateDeltaStream = s_createNamedShadowDeltaUpdatedStream(shadowClient, deltaUpdateStreamFirstEventWaiter, thingName, shadowName);
    ...
    const auto &oldDesiredState = updateStreamFirstEventWaiter.GetResult().Previous.value().State.value().Desired.value();
    auto oldColor = oldDesiredState.View().GetString("color");
    ASSERT_TRUE(oldColor == "green");

    const auto &currentDesiredState = updateStreamFirstEventWaiter.GetResult().Current.value().State.value().Desired.value();
...
{
    Aws::Crt::ApiHandle handle;
    return s_doDeltaUpdateNamedShadowTest(s_createShadowClient5(allocator));
}
