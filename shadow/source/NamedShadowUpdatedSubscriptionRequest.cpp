...
namespace Iotshadow
{
    ...
    void NamedShadowUpdatedSubscriptionRequest::LoadFromObject(NamedShadowUpdatedSubscriptionRequest& val, const Aws::Crt::JsonView &doc)
    {
        (void)val;
        (void)doc;
    ...
    NamedShadowUpdatedSubscriptionRequest& NamedShadowUpdatedSubscriptionRequest::operator=(const Crt::JsonView& doc)
    {
