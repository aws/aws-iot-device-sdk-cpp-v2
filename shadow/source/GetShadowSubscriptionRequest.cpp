...
namespace Iotshadow
{
    ...
    void GetShadowSubscriptionRequest::LoadFromObject(GetShadowSubscriptionRequest& val, const Aws::Crt::JsonView &doc)
    {
        (void)val;
        (void)doc;
    ...
    void GetShadowSubscriptionRequest::SerializeToObject(Aws::Crt::JsonObject& object) const
    {
        (void)object;
