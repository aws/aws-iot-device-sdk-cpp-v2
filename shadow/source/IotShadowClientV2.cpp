...
class ClientV2 : public IClientV2
{
    public:
        ...
        std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> CreateNamedShadowDeltaUpdatedStream(const NamedShadowDeltaUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowDeltaUpdatedEvent> &options) override;

        std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> CreateNamedShadowUpdatedStream(const NamedShadowUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowUpdatedEvent> &options) override;

        std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> CreateShadowDeltaUpdatedStream(const ShadowDeltaUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowDeltaUpdatedEvent> &options) override;

        std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> CreateShadowUpdatedStream(const ShadowUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowUpdatedEvent> &options) override;
...
static void s_DeleteNamedShadowResponseHandler(Aws::Iot::RequestResponse::UnmodeledResult &&result, const std::function<void(DeleteShadowResult &&)> &handler, const Aws::Crt::String &successPathTopic, const Aws::Crt::String &failurePathTopic) {
    ...
    if (responseTopic == successPathTopic) {
        ...
        Aws::Iot::RequestResponse::Result<DeleteShadowResponse, ServiceErrorV2<E>> finalResult(std::move(modeledResponse));
        handler(std::move(finalResult));
...
bool ClientV2::DeleteNamedShadow(const DeleteNamedShadowRequest &request, const DeleteNamedShadowResultHandler &handler) {
    ...
    subscriptionTopicStream << publishTopic << "/+";
    ...
    auto resultHandler =
        [handler, responsePathTopicAccepted, responsePathTopicRejected](Aws::Iot::RequestResponse::UnmodeledResult &&result)
    { s_DeleteNamedShadowResponseHandler(std::move(result), handler, responsePathTopicAccepted, responsePathTopicRejected); };
...
static void s_DeleteShadowResponseHandler(Aws::Iot::RequestResponse::UnmodeledResult &&result, const std::function<void(DeleteShadowResult &&)> &handler, const Aws::Crt::String &successPathTopic, const Aws::Crt::String &failurePathTopic) {
    using E = V2ServiceError;
    using R = Aws::Iot::RequestResponse::Result<DeleteShadowResponse, ServiceErrorV2<E>>;
...
bool ClientV2::DeleteShadow(const DeleteShadowRequest &request, const DeleteShadowResultHandler &handler) {
    ...
    auto resultHandler =
        [handler, responsePathTopicAccepted, responsePathTopicRejected](Aws::Iot::RequestResponse::UnmodeledResult &&result)
    { s_DeleteShadowResponseHandler(std::move(result), handler, responsePathTopicAccepted, responsePathTopicRejected); };
...
static void s_GetNamedShadowResponseHandler(Aws::Iot::RequestResponse::UnmodeledResult &&result, const std::function<void(DeleteShadowResult &&)> &handler, const Aws::Crt::String &successPathTopic, const Aws::Crt::String &failurePathTopic) {
    using E = V2ServiceError;
    ...
    if (responseTopic == successPathTopic) {
        ...
        Aws::Iot::RequestResponse::Result<GetShadowResponse, ServiceErrorV2<E>> finalResult(std::move(modeledResponse));
        handler(std::move(finalResult));
    } else if (responseTopic == failurePathTopic) {
        V2ServiceError modeledError(jsonObject);
        s_applyModeledErrorToHandler<R, E>(handler, std::move(modeledError));
...
bool ClientV2::GetNamedShadow(const GetNamedShadowRequest &request, const GetNamedShadowResultHandler &handler) {
    ...
    auto resultHandler =
        [handler, responsePathTopicAccepted, responsePathTopicRejected](Aws::Iot::RequestResponse::UnmodeledResult &&result)
    { s_GetNamedShadowResponseHandler(std::move(result), handler, responsePathTopicAccepted, responsePathTopicRejected); };
...
static void s_GetShadowResponseHandler(Aws::Iot::RequestResponse::UnmodeledResult &&result, const std::function<void(DeleteShadowResult &&)> &handler, const Aws::Crt::String &successPathTopic, const Aws::Crt::String &failurePathTopic) {
    using E = V2ServiceError;
    using R = Aws::Iot::RequestResponse::Result<GetShadowResponse, ServiceErrorV2<E>>;
...
bool ClientV2::GetShadow(const GetShadowRequest &request, const GetShadowResultHandler &handler) {
    ...
    auto resultHandler =
        [handler, responsePathTopicAccepted, responsePathTopicRejected](Aws::Iot::RequestResponse::UnmodeledResult &&result)
    { s_GetShadowResponseHandler(std::move(result), handler, responsePathTopicAccepted, responsePathTopicRejected); };
...
static void s_UpdateNamedShadowResponseHandler(Aws::Iot::RequestResponse::UnmodeledResult &&result, const std::function<void(DeleteShadowResult &&)> &handler, const Aws::Crt::String &successPathTopic, const Aws::Crt::String &failurePathTopic) {
    using E = V2ServiceError;
    ...
    if (responseTopic == successPathTopic) {
        ...
        Aws::Iot::RequestResponse::Result<UpdateShadowResponse, ServiceErrorV2<E>> finalResult(std::move(modeledResponse));
        handler(std::move(finalResult));
    } else if (responseTopic == failurePathTopic) {
        V2ServiceError modeledError(jsonObject);
        s_applyModeledErrorToHandler<R, E>(handler, std::move(modeledError));
...
bool ClientV2::UpdateNamedShadow(const UpdateNamedShadowRequest &request, const UpdateNamedShadowResultHandler &handler) {
    Aws::Crt::StringStream publishTopicStream;
    ...
    subscriptionTopicStream0 << "$aws/things/" << *request.ThingName << "/shadow/name/" << *request.ShadowName << "/update";
    Aws::Crt::String subscriptionTopic0 = subscriptionTopicStream0.str();

    Aws::Crt::StringStream subscriptionTopicStream1;
    subscriptionTopicStream1 << "$aws/things/" << *request.ThingName << "/shadow/name/" << *request.ShadowName << "/update";
    ...
    auto resultHandler =
        [handler, responsePathTopicAccepted, responsePathTopicRejected](Aws::Iot::RequestResponse::UnmodeledResult &&result)
    { s_UpdateNamedShadowResponseHandler(std::move(result), handler, responsePathTopicAccepted, responsePathTopicRejected); };
...
static void s_UpdateShadowResponseHandler(Aws::Iot::RequestResponse::UnmodeledResult &&result, const std::function<void(DeleteShadowResult &&)> &handler, const Aws::Crt::String &successPathTopic, const Aws::Crt::String &failurePathTopic) {
    using E = V2ServiceError;
    using R = Aws::Iot::RequestResponse::Result<UpdateShadowResponse, ServiceErrorV2<E>>;
...
bool ClientV2::UpdateShadow(const UpdateShadowRequest &request, const UpdateShadowResultHandler &handler) {
    ...
    Aws::Crt::StringStream subscriptionTopicStream0;
    subscriptionTopicStream0 << "$aws/things/" << *request.ThingName << "/shadow/update";
    Aws::Crt::String subscriptionTopic0 = subscriptionTopicStream0.str();

    Aws::Crt::StringStream subscriptionTopicStream1;
    subscriptionTopicStream1 << "$aws/things/" << *request.ThingName << "/shadow/update";
    Aws::Crt::String subscriptionTopic1 = subscriptionTopicStream1.str();
    ...
    auto resultHandler =
        [handler, responsePathTopicAccepted, responsePathTopicRejected](Aws::Iot::RequestResponse::UnmodeledResult &&result)
    { s_UpdateShadowResponseHandler(std::move(result), handler, responsePathTopicAccepted, responsePathTopicRejected); };
...
std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> ClientV2::CreateNamedShadowDeltaUpdatedStream(const NamedShadowDeltaUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowDeltaUpdatedEvent> &options) {
    ...
    return ServiceStreamingOperation<ShadowDeltaUpdatedEvent>::Create(m_allocator, m_bindingClient, topic, options);
}

std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> ClientV2::CreateNamedShadowUpdatedStream(const NamedShadowUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowUpdatedEvent> &options) {
    Aws::Crt::StringStream topicStream;
...
std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> ClientV2::CreateShadowDeltaUpdatedStream(const ShadowDeltaUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowDeltaUpdatedEvent> &options) {
    Aws::Crt::StringStream topicStream;
...
std::shared_ptr<Aws::Iot::RequestResponse::IStreamingOperation> ClientV2::CreateShadowUpdatedStream(const ShadowUpdatedSubscriptionRequest &request, const const Aws::Iot::RequestResponse::StreamingOperationOptions<ShadowUpdatedEvent> &options) {
    Aws::Crt::StringStream topicStream;
