...
void Product::s_loadFromJsonView(Product &product,
  ...
  if (jsonView.ValueExists("price")) {
    product.m_price = Aws::Crt::Optional<float>(
        static_cast<float>(jsonView.GetDouble("price")));
  }
}
...
Product::s_allocateFromPayload(Aws::Crt::StringView stringView,
  ...
  Aws::Crt::ScopedResource<Product> shape(Aws::Crt::New<Product>(allocator),
                                          Product::s_customDeleter);
...
void Customer::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  if (m_id.has_value()) {
...
void Customer::s_loadFromJsonView(Customer &customer,
                                  const Aws::Crt::JsonView &jsonView) noexcept {
  ...
  if (jsonView.ValueExists("firstName")) {
    customer.m_firstName =
        Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("firstName"));
  }
  if (jsonView.ValueExists("lastName")) {
    customer.m_lastName =
        Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("lastName"));
  }
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
Customer::s_allocateFromPayload(Aws::Crt::StringView stringView,
                                Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);

  Aws::Crt::ScopedResource<Customer> shape(Aws::Crt::New<Customer>(allocator),
                                           Customer::s_customDeleter);
  shape->m_allocator = allocator;
...
void Pair::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  if (m_key.has_value()) {
...
void Pair::s_loadFromJsonView(Pair &pair,
                              const Aws::Crt::JsonView &jsonView) noexcept {
  if (jsonView.ValueExists("key")) {
    pair.m_key =
        Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("key"));
  }
  if (jsonView.ValueExists("value")) {
    pair.m_value =
        Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("value"));
  }
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
Pair::s_allocateFromPayload(Aws::Crt::StringView stringView,
                            Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);

  Aws::Crt::ScopedResource<Pair> shape(Aws::Crt::New<Pair>(allocator),
                                       Pair::s_customDeleter);
  shape->m_allocator = allocator;
...
void MessageData::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  ...
  if (m_timeMessage.has_value()) {
    payloadObject.WithDouble("timeMessage",
                             m_timeMessage.value().SecondsWithMSPrecision());
  }
  ...
  if (m_blobMessage.has_value()) {
    if (m_blobMessage.value().size() > 0) {
      payloadObject.WithString("blobMessage",
                               Aws::Crt::Base64Encode(m_blobMessage.value()));
    }
  }
  ...
  if (m_keyValuePairList.has_value()) {
    ...
    for (const auto &keyValuePairListItem : m_keyValuePairList.value()) {
      ...
      keyValuePairListJsonArray.emplace_back(
          std::move(keyValuePairListJsonArrayItem));
    }
  ...
  if (m_stringToValue.has_value()) {
    ...
    for (const auto &stringToValueItem : m_stringToValue.value()) {
      ...
      stringToValueValue.WithObject(stringToValueItem.first,
                                    std::move(stringToValueJsonObject));
    }
    payloadObject.WithObject("stringToValue", std::move(stringToValueValue));
  }
}

void MessageData::s_loadFromJsonView(
    MessageData &messageData, const Aws::Crt::JsonView &jsonView) noexcept {
  if (jsonView.ValueExists("stringMessage")) {
    messageData.m_stringMessage = Aws::Crt::Optional<Aws::Crt::String>(
        jsonView.GetString("stringMessage"));
  }
  if (jsonView.ValueExists("booleanMessage")) {
    messageData.m_booleanMessage =
        Aws::Crt::Optional<bool>(jsonView.GetBool("booleanMessage"));
  }
  if (jsonView.ValueExists("timeMessage")) {
    messageData.m_timeMessage = Aws::Crt::Optional<Aws::Crt::DateTime>(
        Aws::Crt::DateTime(jsonView.GetDouble("timeMessage")));
  }
  if (jsonView.ValueExists("documentMessage")) {
    messageData.m_documentMessage = Aws::Crt::Optional<Aws::Crt::JsonObject>(
        jsonView.GetJsonObject("documentMessage").Materialize());
  }
  if (jsonView.ValueExists("enumMessage")) {
    messageData.m_enumMessage =
        Aws::Crt::Optional<Aws::Crt::String>(jsonView.GetString("enumMessage"));
  }
  ...
  if (jsonView.ValueExists("stringListMessage")) {
    ...
    for (const Aws::Crt::JsonView &stringListJsonView :
         jsonView.GetArray("stringListMessage")) {
      Aws::Crt::Optional<Aws::Crt::String> stringListItem;
      stringListItem =
          Aws::Crt::Optional<Aws::Crt::String>(stringListJsonView.AsString());
  ...
  if (jsonView.ValueExists("keyValuePairList")) {
    ...
    for (const Aws::Crt::JsonView &keyValuePairListJsonView :
         jsonView.GetArray("keyValuePairList")) {
      Aws::Crt::Optional<Pair> keyValuePairListItem;
      keyValuePairListItem = Pair();
      Pair::s_loadFromJsonView(keyValuePairListItem.value(),
                               keyValuePairListJsonView);
      messageData.m_keyValuePairList.value().push_back(
          keyValuePairListItem.value());
    }
  }
  if (jsonView.ValueExists("stringToValue")) {
    messageData.m_stringToValue = Aws::Crt::Map<Aws::Crt::String, Product>();
    for (const auto &stringToValuePair :
         jsonView.GetJsonObject("stringToValue").GetAllObjects()) {
      Aws::Crt::Optional<Product> stringToValueValue;
      stringToValueValue = Product();
      Product::s_loadFromJsonView(stringToValueValue.value(),
                                  stringToValuePair.second);
      messageData.m_stringToValue.value()[stringToValuePair.first] =
          stringToValueValue.value();
    }
  }
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
MessageData::s_allocateFromPayload(Aws::Crt::StringView stringView,
                                   Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
...
void EchoStreamingMessage::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  ...
  } else if (m_chosenMember == TAG_KEY_VALUE_PAIR &&
             m_keyValuePair.has_value()) {
...
void EchoStreamingMessage::s_loadFromJsonView(
  ...
  if (jsonView.ValueExists("streamMessage")) {
    ...
    MessageData::s_loadFromJsonView(
        echoStreamingMessage.m_streamMessage.value(),
        jsonView.GetJsonObject("streamMessage"));
    ...
    Pair::s_loadFromJsonView(echoStreamingMessage.m_keyValuePair.value(),
                             jsonView.GetJsonObject("keyValuePair"));
    echoStreamingMessage.m_chosenMember = TAG_KEY_VALUE_PAIR;
  }
}

EchoStreamingMessage &EchoStreamingMessage::operator=(
    const EchoStreamingMessage &objectToCopy) noexcept {
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoStreamingMessage::s_allocateFromPayload(
  ...
  Aws::Crt::ScopedResource<EchoStreamingMessage> shape(
      Aws::Crt::New<EchoStreamingMessage>(allocator),
      EchoStreamingMessage::s_customDeleter);
  shape->m_allocator = allocator;
...
void EchoStreamingMessage::s_customDeleter(
    EchoStreamingMessage *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void GetAllProductsResponse::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  if (m_products.has_value()) {
    ...
    for (const auto &productMapItem : m_products.value()) {
      ...
      productMapValue.WithObject(productMapItem.first,
                                 std::move(productMapJsonObject));
    }
...
void GetAllProductsResponse::s_loadFromJsonView(
  ...
  if (jsonView.ValueExists("products")) {
    getAllProductsResponse.m_products =
        Aws::Crt::Map<Aws::Crt::String, Product>();
    for (const auto &productMapPair :
         jsonView.GetJsonObject("products").GetAllObjects()) {
      Aws::Crt::Optional<Product> productMapValue;
      productMapValue = Product();
      Product::s_loadFromJsonView(productMapValue.value(),
                                  productMapPair.second);
      getAllProductsResponse.m_products.value()[productMapPair.first] =
          productMapValue.value();
    }
  }
}

const char *GetAllProductsResponse::MODEL_NAME =
    "awstest#GetAllProductsResponse";
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllProductsResponse::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<GetAllProductsResponse> shape(
      Aws::Crt::New<GetAllProductsResponse>(allocator),
      GetAllProductsResponse::s_customDeleter);
  shape->m_allocator = allocator;
...
void GetAllProductsResponse::s_customDeleter(
    GetAllProductsResponse *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void GetAllProductsRequest::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  (void)payloadObject;
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllProductsRequest::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<GetAllProductsRequest> shape(
      Aws::Crt::New<GetAllProductsRequest>(allocator),
...
void GetAllProductsRequest::s_customDeleter(
    GetAllProductsRequest *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void GetAllCustomersResponse::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
...
void GetAllCustomersResponse::s_loadFromJsonView(
  ...
  if (jsonView.ValueExists("customers")) {
    ...
    for (const Aws::Crt::JsonView &customerListJsonView :
         jsonView.GetArray("customers")) {
      Aws::Crt::Optional<Customer> customerListItem;
      customerListItem = Customer();
      Customer::s_loadFromJsonView(customerListItem.value(),
                                   customerListJsonView);
      getAllCustomersResponse.m_customers.value().push_back(
          customerListItem.value());
    }
  }
}

const char *GetAllCustomersResponse::MODEL_NAME =
    "awstest#GetAllCustomersResponse";
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllCustomersResponse::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<GetAllCustomersResponse> shape(
      Aws::Crt::New<GetAllCustomersResponse>(allocator),
      GetAllCustomersResponse::s_customDeleter);
  shape->m_allocator = allocator;
...
void GetAllCustomersResponse::s_customDeleter(
    GetAllCustomersResponse *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void GetAllCustomersRequest::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  (void)payloadObject;
}
...
const char *GetAllCustomersRequest::MODEL_NAME =
    "awstest#GetAllCustomersRequest";
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllCustomersRequest::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<GetAllCustomersRequest> shape(
      Aws::Crt::New<GetAllCustomersRequest>(allocator),
      GetAllCustomersRequest::s_customDeleter);
  shape->m_allocator = allocator;
...
void GetAllCustomersRequest::s_customDeleter(
    GetAllCustomersRequest *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void EchoMessageResponse::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
...
void EchoMessageResponse::s_loadFromJsonView(
  ...
  if (jsonView.ValueExists("message")) {
    ...
    MessageData::s_loadFromJsonView(echoMessageResponse.m_message.value(),
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoMessageResponse::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<EchoMessageResponse> shape(
      Aws::Crt::New<EchoMessageResponse>(allocator),
      EchoMessageResponse::s_customDeleter);
  shape->m_allocator = allocator;
...
void EchoMessageRequest::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  if (m_message.has_value()) {
    Aws::Crt::JsonObject messageDataValue;
    m_message.value().SerializeToJsonObject(messageDataValue);
...
void EchoMessageRequest::s_loadFromJsonView(
  ...
  if (jsonView.ValueExists("message")) {
    ...
    MessageData::s_loadFromJsonView(echoMessageRequest.m_message.value(),
                                    jsonView.GetJsonObject("message"));
  }
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoMessageRequest::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<EchoMessageRequest> shape(
      Aws::Crt::New<EchoMessageRequest>(allocator),
      EchoMessageRequest::s_customDeleter);
  shape->m_allocator = allocator;
...
void EchoStreamingResponse::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  (void)payloadObject;
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoStreamingResponse::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<EchoStreamingResponse> shape(
      Aws::Crt::New<EchoStreamingResponse>(allocator),
      EchoStreamingResponse::s_customDeleter);
  shape->m_allocator = allocator;
...
void EchoStreamingResponse::s_customDeleter(
    EchoStreamingResponse *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void EchoStreamingRequest::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  (void)payloadObject;
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoStreamingRequest::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<EchoStreamingRequest> shape(
      Aws::Crt::New<EchoStreamingRequest>(allocator),
      EchoStreamingRequest::s_customDeleter);
  shape->m_allocator = allocator;
...
void EchoStreamingRequest::s_customDeleter(
    EchoStreamingRequest *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}
...
void CauseServiceErrorResponse::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  (void)payloadObject;
}
...
const char *CauseServiceErrorResponse::MODEL_NAME =
    "awstest#CauseServiceErrorResponse";
...
Aws::Crt::ScopedResource<AbstractShapeBase>
CauseServiceErrorResponse::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<CauseServiceErrorResponse> shape(
      Aws::Crt::New<CauseServiceErrorResponse>(allocator),
      CauseServiceErrorResponse::s_customDeleter);
  shape->m_allocator = allocator;
...
void CauseServiceErrorResponse::s_customDeleter(
    CauseServiceErrorResponse *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}

void CauseServiceErrorRequest::SerializeToJsonObject(
    Aws::Crt::JsonObject &payloadObject) const noexcept {
  (void)payloadObject;
}
...
const char *CauseServiceErrorRequest::MODEL_NAME =
    "awstest#CauseServiceErrorRequest";
...
Aws::Crt::ScopedResource<AbstractShapeBase>
CauseServiceErrorRequest::s_allocateFromPayload(
    Aws::Crt::StringView stringView, Aws::Crt::Allocator *allocator) noexcept {
  Aws::Crt::String payload = {stringView.begin(), stringView.end()};
  Aws::Crt::JsonObject jsonObject(payload);
  Aws::Crt::JsonView jsonView(jsonObject);
  ...
  Aws::Crt::ScopedResource<CauseServiceErrorRequest> shape(
      Aws::Crt::New<CauseServiceErrorRequest>(allocator),
      CauseServiceErrorRequest::s_customDeleter);
  shape->m_allocator = allocator;
...
void CauseServiceErrorRequest::s_customDeleter(
    CauseServiceErrorRequest *shape) noexcept {
  AbstractShapeBase::s_customDeleter(static_cast<AbstractShapeBase *>(shape));
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllProductsOperationContext::AllocateInitialResponseFromPayload(
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllProductsOperationContext::AllocateStreamingResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  (void)stringView;
  (void)allocator;
...
Aws::Crt::String
GetAllProductsOperationContext::GetRequestModelName() const noexcept {
  return Aws::Crt::String("awstest#GetAllProductsRequest");
}

Aws::Crt::String
GetAllProductsOperationContext::GetInitialResponseModelName() const noexcept {
  return Aws::Crt::String("awstest#GetAllProductsResponse");
}

Aws::Crt::Optional<Aws::Crt::String>
GetAllProductsOperationContext::GetStreamingResponseModelName() const noexcept {
  return Aws::Crt::Optional<Aws::Crt::String>();
}

Aws::Crt::String
GetAllProductsOperationContext::GetOperationName() const noexcept {
  return Aws::Crt::String("awstest#GetAllProducts");
}

std::future<GetAllProductsResult>
GetAllProductsOperation::GetResult() noexcept {
  return std::async(std::launch::deferred, [this]() {
    return GetAllProductsResult(GetOperationResult().get());
  });
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
CauseServiceErrorOperationContext::AllocateInitialResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  return CauseServiceErrorResponse::s_allocateFromPayload(stringView,
                                                          allocator);
}

Aws::Crt::ScopedResource<AbstractShapeBase>
CauseServiceErrorOperationContext::AllocateStreamingResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  (void)stringView;
  (void)allocator;
...
Aws::Crt::String
CauseServiceErrorOperationContext::GetRequestModelName() const noexcept {
  return Aws::Crt::String("awstest#CauseServiceErrorRequest");
}

Aws::Crt::String
CauseServiceErrorOperationContext::GetInitialResponseModelName()
    const noexcept {
  return Aws::Crt::String("awstest#CauseServiceErrorResponse");
}

Aws::Crt::Optional<Aws::Crt::String>
CauseServiceErrorOperationContext::GetStreamingResponseModelName()
    const noexcept {
  return Aws::Crt::Optional<Aws::Crt::String>();
}

Aws::Crt::String
CauseServiceErrorOperationContext::GetOperationName() const noexcept {
  return Aws::Crt::String("awstest#CauseServiceError");
}

std::future<CauseServiceErrorResult>
CauseServiceErrorOperation::GetResult() noexcept {
  return std::async(std::launch::deferred, [this]() {
    return CauseServiceErrorResult(GetOperationResult().get());
  });
}
...
void CauseStreamServiceToErrorStreamHandler::OnStreamEvent(
...
CauseStreamServiceToErrorOperationContext::
    CauseStreamServiceToErrorOperationContext(
        const EchoTestRpcServiceModel &serviceModel) noexcept
    : OperationModelContext(serviceModel) {}

Aws::Crt::ScopedResource<AbstractShapeBase>
CauseStreamServiceToErrorOperationContext::AllocateInitialResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
...
Aws::Crt::ScopedResource<AbstractShapeBase>
CauseStreamServiceToErrorOperationContext::AllocateStreamingResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
...
Aws::Crt::String
CauseStreamServiceToErrorOperationContext::GetRequestModelName()
    const noexcept {
  return Aws::Crt::String("awstest#EchoStreamingRequest");
}

Aws::Crt::String
CauseStreamServiceToErrorOperationContext::GetInitialResponseModelName()
    const noexcept {
  return Aws::Crt::String("awstest#EchoStreamingResponse");
}

Aws::Crt::Optional<Aws::Crt::String>
CauseStreamServiceToErrorOperationContext::GetStreamingResponseModelName()
    const noexcept {
  return Aws::Crt::String("awstest#EchoStreamingMessage");
}

Aws::Crt::String
CauseStreamServiceToErrorOperationContext::GetOperationName() const noexcept {
  return Aws::Crt::String("awstest#CauseStreamServiceToError");
}

std::future<CauseStreamServiceToErrorResult>
CauseStreamServiceToErrorOperation::GetResult() noexcept {
  return std::async(std::launch::deferred, [this]() {
...
Aws::Crt::String
CauseStreamServiceToErrorOperation::GetModelName() const noexcept {
  return m_operationModelContext.GetOperationName();
}

void EchoStreamMessagesStreamHandler::OnStreamEvent(
    Aws::Crt::ScopedResource<AbstractShapeBase> response) {
  OnStreamEvent(static_cast<EchoStreamingMessage *>(response.get()));
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoStreamMessagesOperationContext::AllocateInitialResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  return EchoStreamingResponse::s_allocateFromPayload(stringView, allocator);
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoStreamMessagesOperationContext::AllocateStreamingResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  return EchoStreamingMessage::s_allocateFromPayload(stringView, allocator);
}
...
Aws::Crt::String
EchoStreamMessagesOperationContext::GetRequestModelName() const noexcept {
  return Aws::Crt::String("awstest#EchoStreamingRequest");
}

Aws::Crt::String
EchoStreamMessagesOperationContext::GetInitialResponseModelName()
    const noexcept {
  return Aws::Crt::String("awstest#EchoStreamingResponse");
}

Aws::Crt::Optional<Aws::Crt::String>
EchoStreamMessagesOperationContext::GetStreamingResponseModelName()
    const noexcept {
  return Aws::Crt::String("awstest#EchoStreamingMessage");
}

Aws::Crt::String
EchoStreamMessagesOperationContext::GetOperationName() const noexcept {
  return Aws::Crt::String("awstest#EchoStreamMessages");
}

std::future<EchoStreamMessagesResult>
EchoStreamMessagesOperation::GetResult() noexcept {
  return std::async(std::launch::deferred, [this]() {
    return EchoStreamMessagesResult(GetOperationResult().get());
  });
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoMessageOperationContext::AllocateInitialResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
...
Aws::Crt::ScopedResource<AbstractShapeBase>
EchoMessageOperationContext::AllocateStreamingResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  (void)stringView;
  (void)allocator;
...
Aws::Crt::String
EchoMessageOperationContext::GetRequestModelName() const noexcept {
  return Aws::Crt::String("awstest#EchoMessageRequest");
}

Aws::Crt::String
EchoMessageOperationContext::GetInitialResponseModelName() const noexcept {
  return Aws::Crt::String("awstest#EchoMessageResponse");
}

Aws::Crt::Optional<Aws::Crt::String>
EchoMessageOperationContext::GetStreamingResponseModelName() const noexcept {
  return Aws::Crt::Optional<Aws::Crt::String>();
}

Aws::Crt::String
EchoMessageOperationContext::GetOperationName() const noexcept {
  return Aws::Crt::String("awstest#EchoMessage");
}

std::future<EchoMessageResult> EchoMessageOperation::GetResult() noexcept {
  return std::async(std::launch::deferred, [this]() {
    return EchoMessageResult(GetOperationResult().get());
  });
}
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllCustomersOperationContext::AllocateInitialResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
...
Aws::Crt::ScopedResource<AbstractShapeBase>
GetAllCustomersOperationContext::AllocateStreamingResponseFromPayload(
    Aws::Crt::StringView stringView,
    Aws::Crt::Allocator *allocator) const noexcept {
  (void)stringView;
  (void)allocator;
...
Aws::Crt::String
GetAllCustomersOperationContext::GetRequestModelName() const noexcept {
  return Aws::Crt::String("awstest#GetAllCustomersRequest");
}

Aws::Crt::String
GetAllCustomersOperationContext::GetInitialResponseModelName() const noexcept {
  return Aws::Crt::String("awstest#GetAllCustomersResponse");
}

Aws::Crt::Optional<Aws::Crt::String>
GetAllCustomersOperationContext::GetStreamingResponseModelName()
    const noexcept {
  return Aws::Crt::Optional<Aws::Crt::String>();
}

Aws::Crt::String
GetAllCustomersOperationContext::GetOperationName() const noexcept {
  return Aws::Crt::String("awstest#GetAllCustomers");
}

std::future<GetAllCustomersResult>
GetAllCustomersOperation::GetResult() noexcept {
  return std::async(std::launch::deferred, [this]() {
    return GetAllCustomersResult(GetOperationResult().get());
  });
}
...
EchoTestRpcServiceModel::EchoTestRpcServiceModel() noexcept
    : m_getAllProductsOperationContext(*this),
      m_causeServiceErrorOperationContext(*this),
      m_causeStreamServiceToErrorOperationContext(*this),
      m_echoStreamMessagesOperationContext(*this),
      m_echoMessageOperationContext(*this),
      m_getAllCustomersOperationContext(*this) {}

Aws::Crt::ScopedResource<OperationError>
EchoTestRpcServiceModel::AllocateOperationErrorFromPayload(
