...
std::shared_ptr<GetAllProductsOperation>
EchoTestRpcClient::NewGetAllProducts() noexcept {
  auto operation = Aws::Crt::MakeShared<GetAllProductsOperation>(
      m_allocator, m_connection,
      m_echoTestRpcServiceModel.m_getAllProductsOperationContext, m_allocator);
  operation->WithLaunchMode(m_asyncLaunchMode);
  return operation;
}

std::shared_ptr<CauseServiceErrorOperation>
EchoTestRpcClient::NewCauseServiceError() noexcept {
...
std::shared_ptr<CauseStreamServiceToErrorOperation>
EchoTestRpcClient::NewCauseStreamServiceToError(
    std::shared_ptr<CauseStreamServiceToErrorStreamHandler>
...
std::shared_ptr<EchoStreamMessagesOperation>
EchoTestRpcClient::NewEchoStreamMessages(
...
std::shared_ptr<EchoMessageOperation>
EchoTestRpcClient::NewEchoMessage() noexcept {
  auto operation = Aws::Crt::MakeShared<EchoMessageOperation>(
      m_allocator, m_connection,
      m_echoTestRpcServiceModel.m_echoMessageOperationContext, m_allocator);
  operation->WithLaunchMode(m_asyncLaunchMode);
  return operation;
}

std::shared_ptr<GetAllCustomersOperation>
EchoTestRpcClient::NewGetAllCustomers() noexcept {
  auto operation = Aws::Crt::MakeShared<GetAllCustomersOperation>(
      m_allocator, m_connection,
      m_echoTestRpcServiceModel.m_getAllCustomersOperationContext, m_allocator);
  operation->WithLaunchMode(m_asyncLaunchMode);
  return operation;
}
