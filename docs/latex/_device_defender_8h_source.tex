...
\DoxyCodeLine{8 }
\DoxyCodeLine{9 \textcolor{preprocessor}{\#include <aws/crt/io/EventLoopGroup.h>}}
\DoxyCodeLine{10 \textcolor{preprocessor}{\#include <aws/crt/mqtt/MqttClient.h>}}
\DoxyCodeLine{11 }
\DoxyCodeLine{12 \textcolor{preprocessor}{\#include <aws/iotdevice/device\_defender.h>}}
\DoxyCodeLine{13 }
...
\DoxyCodeLine{31 }
\DoxyCodeLine{32         \textcolor{keyword}{using} \mbox{\hyperlink{namespace_aws_1_1_iotdevicedefenderv1_a71ad2593d960b1d91bdf3152cb72e19a}{ReportFormat}} = aws\_iotdevice\_defender\_report\_format;}
\DoxyCodeLine{33 }
...
\DoxyCodeLine{42         \};}
\DoxyCodeLine{43 }
\DoxyCodeLine{47         \textcolor{keyword}{class }\mbox{\hyperlink{devicedefender_2include_2aws_2iotdevicedefender_2_exports_8h_aa6735d61baab66e47a24794702ee4444}{AWS\_IOTDEVICEDEFENDER\_API}} \mbox{\hyperlink{class_aws_1_1_iotdevicedefenderv1_1_1_report_task}{ReportTask}} final}
\DoxyCodeLine{48         \{}
...
\DoxyCodeLine{74 }
\DoxyCodeLine{78             \textcolor{keywordtype}{int} LastError() const noexcept \{ \textcolor{keywordflow}{return} m\_lastError; \}}
\DoxyCodeLine{79 }
\DoxyCodeLine{80           \textcolor{keyword}{private}:}
\DoxyCodeLine{81             Crt::Allocator *m\_allocator;}
...
\DoxyCodeLine{87             Crt::Io::EventLoopGroup \&m\_eventLoopGroup;}
\DoxyCodeLine{88 }
\DoxyCodeLine{89             \mbox{\hyperlink{class_aws_1_1_iotdevicedefenderv1_1_1_report_task}{ReportTask}}(}
\DoxyCodeLine{90                 Crt::Allocator *allocator,}
\DoxyCodeLine{91                 std::shared\_ptr<Crt::Mqtt::MqttConnection> mqttConnection,}
\DoxyCodeLine{92                 \textcolor{keyword}{const} Crt::String \&thingName,}
\DoxyCodeLine{93                 Crt::Io::EventLoopGroup \&eventLoopGroup,}
\DoxyCodeLine{94                 \mbox{\hyperlink{namespace_aws_1_1_iotdevicedefenderv1_a71ad2593d960b1d91bdf3152cb72e19a}{ReportFormat}} reportFormat,}
\DoxyCodeLine{95                 uint32\_t taskPeriodSeconds,}
\DoxyCodeLine{96                 uint32\_t networkConnectionSamplePeriodSeconds,}
\DoxyCodeLine{97                 \mbox{\hyperlink{namespace_aws_1_1_iotdevicedefenderv1_a809b6645d5d82549c8a2436fc68a6925}{OnTaskCancelledHandler}} \&\&onCancelled = NULL,}
...
\DoxyCodeLine{101         \};}
\DoxyCodeLine{102 }
\DoxyCodeLine{106         class \mbox{\hyperlink{devicedefender_2include_2aws_2iotdevicedefender_2_exports_8h_aa6735d61baab66e47a24794702ee4444}{AWS\_IOTDEVICEDEFENDER\_API}} \mbox{\hyperlink{class_aws_1_1_iotdevicedefenderv1_1_1_report_task_builder}{ReportTaskBuilder}} final}
\DoxyCodeLine{107         \{}
...
\DoxyCodeLine{110                 Crt::Allocator *allocator,}
\DoxyCodeLine{111                 std::shared\_ptr<Crt::Mqtt::MqttConnection> mqttConnection,}
\DoxyCodeLine{112                 Crt::Io::EventLoopGroup \&eventLoopGroup,}
\DoxyCodeLine{113                 \textcolor{keyword}{const} Crt::String \&thingName);}
\DoxyCodeLine{114 }
\DoxyCodeLine{118             \mbox{\hyperlink{class_aws_1_1_iotdevicedefenderv1_1_1_report_task_builder}{ReportTaskBuilder}} \&WithReportFormat(\mbox{\hyperlink{namespace_aws_1_1_iotdevicedefenderv1_a71ad2593d960b1d91bdf3152cb72e19a}{ReportFormat}} reportFormat) \textcolor{keyword}{noexcept};}
\DoxyCodeLine{119 }
...
\DoxyCodeLine{147             Crt::Allocator *m\_allocator;}
\DoxyCodeLine{148             std::shared\_ptr<Crt::Mqtt::MqttConnection> m\_mqttConnection;}
\DoxyCodeLine{149             Crt::String m\_thingName;}
\DoxyCodeLine{150             Crt::Io::EventLoopGroup \&m\_eventLoopGroup;}
\DoxyCodeLine{151             \mbox{\hyperlink{namespace_aws_1_1_iotdevicedefenderv1_a71ad2593d960b1d91bdf3152cb72e19a}{ReportFormat}} m\_reportFormat;}
