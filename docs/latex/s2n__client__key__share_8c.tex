...
{\footnotesize\ttfamily static int s2n\+\_\+client\+\_\+key\+\_\+share\+\_\+recv\+\_\+pq\+\_\+hybrid (\begin{DoxyParamCaption}\item[{struct \mbox{\hyperlink{structs2n__connection}{s2n\+\_\+connection}} $\ast$}]{conn,  }\item[{struct \mbox{\hyperlink{structs2n__stuffer}{s2n\+\_\+stuffer}} $\ast$}]{key\+\_\+share,  }\item[{uint16\+\_\+t}]{kem\+\_\+group\+\_\+iana\+\_\+id,  }\item[{bool $\ast$}]{match }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
