\label{index_md_crt_aws_c_iot_README}%
\Hypertarget{index_md_crt_aws_c_iot_README}%
 C99 implementation of AWS IoT cloud services integration with devices\hypertarget{index_autotoc_md17}{}\doxysection{License}\label{index_autotoc_md17}
This library is licensed under the Apache 2.\+0 License.\hypertarget{index_autotoc_md18}{}\doxysection{Usage}\label{index_autotoc_md18}
\hypertarget{index_autotoc_md19}{}\doxysubsection{Building}\label{index_autotoc_md19}
\hypertarget{index_autotoc_md20}{}\doxysubsubsection{Building s2n (\+Linux Only)}\label{index_autotoc_md20}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md21}{}\doxysubsubsection{Building aws-\/c-\/iot and Remaining Dependencies}\label{index_autotoc_md21}
