...
\DoxyCodeLine{8 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{_socket_options_8h}{aws/crt/io/SocketOptions.h}}>}}
\DoxyCodeLine{9 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{secure__tunneling_8h}{aws/iotdevice/secure\_tunneling.h}}>}}
...
\DoxyCodeLine{20         \textcolor{keyword}{using} \mbox{\hyperlink{namespace_aws_1_1_iotsecuretunneling_aec68b693857dd6354693d8400bcf36ad}{OnDataReceive}} = std::function<void(\textcolor{keyword}{const} \mbox{\hyperlink{structaws__byte__buf}{Crt::ByteBuf}} \&data)>;}
...
\DoxyCodeLine{24 }
\DoxyCodeLine{25         \textcolor{keyword}{class }\mbox{\hyperlink{secure__tunneling_2include_2aws_2iotsecuretunneling_2_exports_8h_a66e3e73c52342d65d13175576f5d5da0}{AWS\_IOTSECURETUNNELING\_API}} \mbox{\hyperlink{class_aws_1_1_iotsecuretunneling_1_1_secure_tunnel}{SecureTunnel}} \mbox{\hyperlink{lookup3_8inl_ab4646d77540701d2eb2c877effbe5739}{final}}}
\DoxyCodeLine{26         \{}
...
\DoxyCodeLine{30                 \mbox{\hyperlink{structaws__allocator}{Crt::Allocator}} *\mbox{\hyperlink{socket__test_8c_a130cc941753892421e3f70bdee1049d1}{allocator}},                        \textcolor{comment}{// Should out live this object}}
\DoxyCodeLine{31                 \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_client_bootstrap}{Aws::Crt::Io::ClientBootstrap}} *clientBootstrap,   \textcolor{comment}{// Should out live this object}}
\DoxyCodeLine{32                 \textcolor{keyword}{const} \mbox{\hyperlink{class_aws_1_1_crt_1_1_io_1_1_socket_options}{Aws::Crt::Io::SocketOptions}} \&socketOptions, \textcolor{comment}{// Make a copy and save in this object}}
\DoxyCodeLine{33 }
\DoxyCodeLine{34                 \textcolor{keyword}{const} \mbox{\hyperlink{aws-c-iot_2include_2aws_2iotdevice_2external_2c_j_s_o_n_8h_addf925fe055723aa55a381a1ba45bda2}{std::string}} \&accessToken, \textcolor{comment}{// Make a copy and save in this object}}
\DoxyCodeLine{35                 \mbox{\hyperlink{secure__tunneling_8h_a40266602b0be790c0fcb999ee01f1f1e}{aws\_secure\_tunneling\_local\_proxy\_mode}} localProxyMode,}
\DoxyCodeLine{36                 \textcolor{keyword}{const} \mbox{\hyperlink{aws-c-iot_2include_2aws_2iotdevice_2external_2c_j_s_o_n_8h_addf925fe055723aa55a381a1ba45bda2}{std::string}} \&endpointHost, \textcolor{comment}{// Make a copy and save in this object}}
\DoxyCodeLine{37                 \textcolor{keyword}{const} \mbox{\hyperlink{aws-c-iot_2include_2aws_2iotdevice_2external_2c_j_s_o_n_8h_addf925fe055723aa55a381a1ba45bda2}{std::string}} \&rootCa,       \textcolor{comment}{// Make a copy and save in this object}}
\DoxyCodeLine{38 }
...
\DoxyCodeLine{57 }
\DoxyCodeLine{58             \textcolor{keywordtype}{int} SendData(const Crt::\mbox{\hyperlink{namespace_aws_1_1_crt_a14ac076b0baa520bccb2b7236e4e78b7}{ByteCursor}} \&data);}
\DoxyCodeLine{59 }
\DoxyCodeLine{60             \textcolor{keywordtype}{int} SendStreamStart();}
\DoxyCodeLine{61 }
\DoxyCodeLine{62             \textcolor{keywordtype}{int} SendStreamReset();}
\DoxyCodeLine{63 }
\DoxyCodeLine{64             \mbox{\hyperlink{structaws__secure__tunnel}{aws\_secure\_tunnel}} *GetUnderlyingHandle();}
\DoxyCodeLine{65 }
\DoxyCodeLine{66           private:}
\DoxyCodeLine{67             \textcolor{comment}{// aws-\/c-\/iot callbacks}}
\DoxyCodeLine{68             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_aed977892cf1daa56f3fa98da61e85b50}{s\_OnConnectionComplete}}(\textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{69             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_aeba26137f46633a6653313f80ab2db97}{s\_OnConnectionShutdown}}(\textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{70             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_a2676eda6ee62171f5712858a307a6308}{s\_OnSendDataComplete}}(\textcolor{keywordtype}{int} \mbox{\hyperlink{channel__handler__test_8c_a7d16b1c68c87cec009d972e79abfba78}{error\_code}}, \textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{71             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_a9e42b8b1ba30e59e61da924cb4902628}{s\_OnDataReceive}}(const struct \mbox{\hyperlink{structaws__byte__buf}{aws\_byte\_buf}} *data, \textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{72             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_a52e926e0d73c048d49bdafc196dbdd6d}{s\_OnStreamStart}}(\textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{73             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_a9a09c26909cf669a33705118c65df499}{s\_OnStreamReset}}(\textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{74             static \textcolor{keywordtype}{void} \mbox{\hyperlink{_secure_tunnel_test_8cpp_ac541f7b22f61852256d614f1e185ea18}{s\_OnSessionReset}}(\textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{75 }
...
\DoxyCodeLine{86             \mbox{\hyperlink{namespacestd}{std}}::\textcolor{keywordtype}{string} m\_accessToken;}
\DoxyCodeLine{87             \mbox{\hyperlink{namespacestd}{std}}::\textcolor{keywordtype}{string} m\_endpointHost;}
\DoxyCodeLine{88             \mbox{\hyperlink{namespacestd}{std}}::\textcolor{keywordtype}{string} m\_rootCa;}
\DoxyCodeLine{89 }
\DoxyCodeLine{90             \mbox{\hyperlink{structaws__secure__tunnel}{aws\_secure\_tunnel}} *m\_secure\_tunnel;}
\DoxyCodeLine{91         \};}
