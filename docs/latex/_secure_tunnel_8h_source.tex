...
\DoxyCodeLine{30                 \mbox{\hyperlink{structaws__allocator}{Crt::Allocator}} *allocator,                        \textcolor{comment}{// Should out live this object}}
...
\DoxyCodeLine{68             static \textcolor{keywordtype}{void} s\_OnConnectionComplete(\textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{69             static \textcolor{keywordtype}{void} s\_OnConnectionShutdown(\textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{70             static \textcolor{keywordtype}{void} s\_OnSendDataComplete(\textcolor{keywordtype}{int} error\_code, \textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{71             static \textcolor{keywordtype}{void} s\_OnDataReceive(const struct \mbox{\hyperlink{structaws__byte__buf}{aws\_byte\_buf}} *data, \textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{72             static \textcolor{keywordtype}{void} s\_OnStreamStart(\textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{73             static \textcolor{keywordtype}{void} s\_OnStreamReset(\textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{74             static \textcolor{keywordtype}{void} s\_OnSessionReset(\textcolor{keywordtype}{void} *user\_data);}
\DoxyCodeLine{75 }
