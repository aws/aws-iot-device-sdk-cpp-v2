...
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md144}{}\doxysubsection{How should I select the initial entry-\/point to verify?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md144}
There are two basic approaches that we have used at AWS to verify C code using CBMC\+: {\bfseries{top down}}, and {\bfseries{bottom up}}. In our experience, the top-\/down approach is best suited to a\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md145}{}\doxysubsubsection{Top down approach}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md145}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md146}{}\doxysubsubsection{Bottom up approach}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md146}
...
\end{DoxyEnumerate}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md147}{}\doxysubsection{How do I set up the tools I need?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md147}
\mbox{[}TODO\mbox{]} -\/ basically brew install / apt-\/get install. Link to that page.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md148}{}\doxysubsection{How do I set up my repository for verification?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md148}
...
\end{DoxyEnumerate}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md149}{}\doxysubsection{How do I write a good proof harness?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md149}
...
In fact, historically, we started from unit tests, and tried to make them symbolic by replacing concrete values with unconstrained values. We found this difficult, since there are relations that constrain fields in a data structure and must be enforced (e.\+g., {\ttfamily length \texorpdfstring{$<$}{<} capacity} and {\ttfamily capacity != 0 IMPLIES buffer != 0}). Even worse, these imperative proof-\/harnesses turned out to be difficult to reason about and to explain to the development team.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md150}{}\doxysubsection{How do I write function pre/post conditions?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md150}
...
\end{DoxyEnumerate}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md151}{}\doxysubsection{How do I write a proof Makefile?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md151}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md152}{}\doxysubsection{How do I write a good ensures function?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md152}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md153}{}\doxysubsection{How should I write a good is\+\_\+valid function?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md153}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md154}{}\doxysubsection{I see 12 proof failures. How do I select which one to debug?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md154}
...
\end{DoxyEnumerate}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md155}{}\doxysubsection{How do I debug a proof failure?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md155}
There are a number of techniques that have proven useful in debugging proof failures.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md156}{}\doxysubsection{What are some examples of good CBMC proofs?}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__f_a_q_autotoc_md156}
