...
SCRAM is a symmetric encryption mode, based on AES-\/\+GCM, that includes new cryptographic protections against dangerous short-\/cuts that applications sometimes take.\hypertarget{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md498}{}\doxysection{Cryptographic protection against release of unauthenticated plaintext}\label{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md498}
...
Applications using SCRAM don\textquotesingle{}t have to use padding, it\textquotesingle{}s not enforced, but adding padding to the AEAD layer acts as a noteworthy reminder to application developers and code-\/auditors that obfuscation of message sizes and timings is an important consideration for cryptographic systems. For example, it will be noticable during a code-\/review that padding has not been chosen.\hypertarget{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md500}{}\doxysection{SCRAM algorithm}\label{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md500}
...
Once measurements and any changes are finalized, we will be publishing a final SCRAM specification, accompanying security proofs, and other learnings.\hypertarget{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md501}{}\doxysection{SCRAM material}\label{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md501}
...
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md502}{}\doxysection{SCRAM team}\label{md_crt_aws_crt_cpp_crt_s2n_scram__r_e_a_d_m_e_autotoc_md502}
