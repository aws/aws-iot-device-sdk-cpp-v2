\hypertarget{ctverif_2s2n__annotations_8h_source}{}\doxysection{s2n\+\_\+annotations.\+h}
\label{ctverif_2s2n__annotations_8h_source}\index{crt/aws-\/crt-\/cpp/crt/s2n/tests/ctverif/s2n\_annotations.h@{crt/aws-\/crt-\/cpp/crt/s2n/tests/ctverif/s2n\_annotations.h}}
\mbox{\hyperlink{ctverif_2s2n__annotations_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{17 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{ct-verif_8h}{ct-\/verif.h}}"{}}}
\DoxyCodeLine{18 }
\DoxyCodeLine{19 \textcolor{comment}{/* Override the annotations to the ones that ct-\/verif expects */}}
\DoxyCodeLine{20 \textcolor{preprocessor}{\#define S2N\_PUBLIC\_INPUT(\_\_a) public\_in( \_\_SMACK\_value( \_\_a ) )}}
