This is a cross-\/platform C99 implementation of compression algorithms such as gzip, and huffman encoding/decoding. Currently only huffman is implemented.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md184}{}\doxysection{License}\label{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md184}
This library is licensed under the Apache 2.\+0 License.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md185}{}\doxysection{Usage}\label{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md185}
This library has a strong dependency on \href{https://github.com/awslabs/aws-c-common}{\texttt{ aws-\/c-\/common}}. Please see that repository\textquotesingle{}s \href{https://github.com/awslabs/aws-c-common/blob/master/README.md}{\texttt{ README.\+md}} for information on how to install it.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md186}{}\doxysubsection{Huffman}\label{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md186}
...
\DoxyCodeLine{HUFFMAN\_CODE(  0,      \textcolor{stringliteral}{"{}1100101110"{}}, 0x32e, 10)}
\DoxyCodeLine{HUFFMAN\_CODE(  1,      "{}1100101111"{}, 0x32f, 10)}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include <aws/testing/compression/huffman.h>}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{static} \textcolor{keyword}{struct }huffman\_test\_code\_point \mbox{\hyperlink{generator_8c_abed2c35818733bc0405f93692efa135a}{code\_points}}[] = \{}
...
\DoxyCodeLine{\mbox{\hyperlink{huffman_8h_aef42048ee2ee54c445163ca4dfb05b84}{aws\_huffman\_encoder\_init}}(\&encoder, \{coder\_name\}\_get\_coder());}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{struct }\mbox{\hyperlink{structaws__huffman__decoder}{aws\_huffman\_decoder}} decoder;}
\DoxyCodeLine{\mbox{\hyperlink{huffman_8h_acbe357203649d987303f9194d7cf2c7c}{aws\_huffman\_decoder\_init}}(\&decoder, \{coder\_name\}\_get\_coder())}

\end{DoxyCode}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md187}{}\doxysubsubsection{Encoding}\label{md_crt_aws_crt_cpp_crt_aws_c_compression__r_e_a_d_m_e_autotoc_md187}

\begin{DoxyCode}{0}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{int} \mbox{\hyperlink{huffman_8h_abb6619ecad41953fa7c46a4577a9a6a7}{aws\_huffman\_encode}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structaws__huffman__encoder}{aws\_huffman\_encoder}} *encoder, \textcolor{keyword}{const} \textcolor{keywordtype}{char} *to\_encode, \textcolor{keywordtype}{size\_t} *\mbox{\hyperlink{iocp__event__loop_8c_a09ef0d7d086ae398d78b446470ae8b3a}{length}}, uint8\_t *output, \textcolor{keywordtype}{size\_t} *output\_size);}
...
\DoxyCodeLine{        uint8\_t output[some\_chunk\_size];}
\DoxyCodeLine{        \textcolor{keywordtype}{size\_t} output\_size = \textcolor{keyword}{sizeof}(output);}
\DoxyCodeLine{        \textcolor{keywordtype}{size\_t} bytes\_read = size;}
\DoxyCodeLine{        \mbox{\hyperlink{huffman_8h_abb6619ecad41953fa7c46a4577a9a6a7}{aws\_huffman\_encode}}(encoder, to\_encode, \&bytes\_read, output, \&output\_size);}
\DoxyCodeLine{        \textcolor{comment}{/* AWS\_ERROR\_SHORT\_BUFFER was raised... */}}
\DoxyCodeLine{        send\_output\_to\_someone\_else(output, output\_size);}
\DoxyCodeLine{}
...
\DoxyCodeLine{        \textcolor{keywordtype}{size\_t} output\_size = \textcolor{keyword}{sizeof}(output);}
\DoxyCodeLine{        \textcolor{keywordtype}{size\_t} bytes\_read = size;}
\DoxyCodeLine{        \mbox{\hyperlink{huffman_8h_a13f0c95fa9e1f8471f63a19fd402010f}{aws\_huffman\_decode}}(decoder, to\_decode, \&bytes\_read, output, \&output\_size);}
\DoxyCodeLine{        \textcolor{comment}{/* AWS\_ERROR\_SHORT\_BUFFER was raised... */}}
\DoxyCodeLine{        send\_output\_to\_someone\_else(output, output\_size);}
\DoxyCodeLine{}
...
\DoxyCodeLine{    \mbox{\hyperlink{huffman_8h_a34c1b6073a00cf0933968f7fb9e699bb}{aws\_huffman\_decoder\_reset}}(decoder);}
\DoxyCodeLine{\}}
