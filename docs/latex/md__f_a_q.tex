\hypertarget{md__f_a_q_autotoc_md621}{}\doxysubsection{Where should I start?}\label{md__f_a_q_autotoc_md621}
If you are just getting started make sure you \href{https://github.com/aws/aws-iot-device-sdk-cpp-v2\#installation}{\texttt{ install this sdk}} and then build and run the \href{https://github.com/aws/aws-iot-device-sdk-cpp-v2/tree/main/samples\#basic-mqtt-pub-sub}{\texttt{ basic Pub\+Sub}}\hypertarget{md__f_a_q_autotoc_md622}{}\doxysubsection{I keep getting AWS\+\_\+\+ERROR\+\_\+\+MQTT\+\_\+\+UNEXPECTED\+\_\+\+HANGUP}\label{md__f_a_q_autotoc_md622}
...
After getting it working make sure to only allow the actions and resources that you need. More info about IoT IAM policies can be found \href{https://docs.aws.amazon.com/iot/latest/developerguide/security_iam_service-with-iam.html}{\texttt{ here}}.\hypertarget{md__f_a_q_autotoc_md623}{}\doxysubsection{Dependencies are bad.}\label{md__f_a_q_autotoc_md623}
...
{\ttfamily git clone -\/-\/recursive \href{https://github.com/aws/aws-iot-device-sdk-cpp-v2.git}{\texttt{ https\+://github.\+com/aws/aws-\/iot-\/device-\/sdk-\/cpp-\/v2.\+git}}}\hypertarget{md__f_a_q_autotoc_md624}{}\doxysubsection{Detecting connection loss (tldr use keep\+Alive\+Time\+Secs and ping\+Timeout\+Ms)}\label{md__f_a_q_autotoc_md624}
...
\end{DoxyEnumerate}\hypertarget{md__f_a_q_autotoc_md625}{}\doxysubsection{How to use a Pre-\/\+Built aws-\/crt-\/cpp (\+Most useful for development of this package)}\label{md__f_a_q_autotoc_md625}
...
\end{DoxyCode}
\hypertarget{md__f_a_q_autotoc_md626}{}\doxysubsection{Mac-\/\+Only TLS Behavior}\label{md__f_a_q_autotoc_md626}
