...
After getting it working make sure to only allow the actions and resources that you need. More info about IoT IAM policies can be found \href{https://docs.aws.amazon.com/iot/latest/developerguide/security_iam_service-with-iam.html}{\texttt{ here}}.\hypertarget{md__f_a_q_autotoc_md11}{}\doxysubsection{Could NOT find Lib\+Crypto (missing\+: Lib\+Crypto\+\_\+\+LIBRARY)}\label{md__f_a_q_autotoc_md11}
Add {\ttfamily -\/DBUILD\+\_\+\+SHARED\+\_\+\+LIBS=ON} to your first cmake command\hypertarget{md__f_a_q_autotoc_md12}{}\doxysubsection{Dependencies are bad.}\label{md__f_a_q_autotoc_md12}
...
{\ttfamily git clone -\/-\/recursive \href{https://github.com/aws/aws-iot-device-sdk-cpp-v2.git}{\texttt{ https\+://github.\+com/aws/aws-\/iot-\/device-\/sdk-\/cpp-\/v2.\+git}}}\hypertarget{md__f_a_q_autotoc_md13}{}\doxysubsection{Detecting connection loss (tldr use keep\+Alive\+Time\+Secs and ping\+Timeout\+Ms)}\label{md__f_a_q_autotoc_md13}
...
\end{DoxyEnumerate}\hypertarget{md__f_a_q_autotoc_md14}{}\doxysubsection{How to use a Pre-\/\+Built aws-\/crt-\/cpp (\+Most useful for development of this package)}\label{md__f_a_q_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md__f_a_q_autotoc_md15}{}\doxysubsection{Mac-\/\+Only TLS Behavior}\label{md__f_a_q_autotoc_md15}
