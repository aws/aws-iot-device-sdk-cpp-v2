\hypertarget{bike__r1_2aes__wrap_8h_source}{}\doxysection{aes\+\_\+wrap.\+h}
\label{bike__r1_2aes__wrap_8h_source}\index{crt/aws-\/crt-\/cpp/crt/s2n/pq-\/crypto/bike\_r1/aes\_wrap.h@{crt/aws-\/crt-\/cpp/crt/s2n/pq-\/crypto/bike\_r1/aes\_wrap.h}}
\mbox{\hyperlink{bike__r1_2aes__wrap_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{12 \textcolor{preprocessor}{\#include <openssl/evp.h>}}
\DoxyCodeLine{13 }
...
\DoxyCodeLine{22 \{}
\DoxyCodeLine{23   uint8\_t \mbox{\hyperlink{aws-c-iot_2include_2aws_2iotdevice_2external_2c_j_s_o_n_8h_a788db922597cf2fb6389e278f822e59f}{raw}}[\mbox{\hyperlink{bike__r1_2aes__wrap_8h_a5a64a2e860ad4e5012c6dbcd19c77210}{AES256\_KEY\_SIZE}}];}
...
\DoxyCodeLine{33 \textcolor{keyword}{typedef} EVP\_CIPHER\_CTX *\mbox{\hyperlink{bike__r1_2aes__wrap_8h_a02339f74806faf073c6ece7ddc667c7a}{aes256\_ks\_t}};}
\DoxyCodeLine{34 }
...
\DoxyCodeLine{37 \{}
\DoxyCodeLine{38   *ks = EVP\_CIPHER\_CTX\_new();}
...
\DoxyCodeLine{42   \}}
\DoxyCodeLine{43   \textcolor{keywordflow}{if}(0 == EVP\_EncryptInit\_ex(*ks, EVP\_aes\_256\_ecb(), \mbox{\hyperlink{namespace_aws_a41b67e809416e9bd96026fa1f414925d}{NULL}}, key-\/>raw, \mbox{\hyperlink{namespace_aws_a41b67e809416e9bd96026fa1f414925d}{NULL}}))}
\DoxyCodeLine{44   \{}
\DoxyCodeLine{45     EVP\_CIPHER\_CTX\_free(*ks);}
\DoxyCodeLine{46     \mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_afd0143325cf546e89c70dca08cae0cd6}{BIKE\_ERROR}}(\mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_a16e0968bf2b44ba99b9a308421014f4daea0e29ca080099a04169f1e9182357b0}{EXTERNAL\_LIB\_ERROR\_OPENSSL}});}
\DoxyCodeLine{47   \}}
\DoxyCodeLine{48 }
\DoxyCodeLine{49   EVP\_CIPHER\_CTX\_set\_padding(*ks, 0);}
\DoxyCodeLine{50 }
\DoxyCodeLine{51   \textcolor{keywordflow}{return} \mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_aa90cac659d18e8ef6294c7ae337f6b58}{SUCCESS}};}
\DoxyCodeLine{52 \}}
\DoxyCodeLine{53 }
\DoxyCodeLine{54 \mbox{\hyperlink{bike__r1_2defs_8h_ad320c6003c1b51d78cb343e674b9432f}{\_INLINE\_}} \mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_ae78f298365f3659d41525fa9b2b855e2}{ret\_t}}}
\DoxyCodeLine{55 \mbox{\hyperlink{bike__r1_2aes__wrap_8h_a8b3488b91a14b4c3801052d12eba63a7}{aes256\_enc}}(\mbox{\hyperlink{bike__r1__kem_8h_aec78e7a9e90a406a56f859ee456e8eae}{OUT}} uint8\_t *ct, \mbox{\hyperlink{bike__r1__kem_8h_ac2bbd6d630a06a980d9a92ddb9a49928}{IN}} \textcolor{keyword}{const} uint8\_t *pt, \mbox{\hyperlink{bike__r1__kem_8h_ac2bbd6d630a06a980d9a92ddb9a49928}{IN}} \textcolor{keyword}{const} \mbox{\hyperlink{bike__r1_2aes_8h_a02339f74806faf073c6ece7ddc667c7a}{aes256\_ks\_t}} *ks)}
\DoxyCodeLine{56 \{}
\DoxyCodeLine{57   \textcolor{keywordtype}{int} outlen = 0;}
\DoxyCodeLine{58   \textcolor{keywordflow}{if}(0 == EVP\_EncryptUpdate(*ks, ct, \&outlen, pt, \mbox{\hyperlink{bike__r1_2aes__wrap_8h_a53a76dc39f18601d88f17ed29a71d649}{AES256\_BLOCK\_SIZE}}))}
\DoxyCodeLine{59   \{}
\DoxyCodeLine{60     \mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_afd0143325cf546e89c70dca08cae0cd6}{BIKE\_ERROR}}(\mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_a16e0968bf2b44ba99b9a308421014f4daea0e29ca080099a04169f1e9182357b0}{EXTERNAL\_LIB\_ERROR\_OPENSSL}});}
\DoxyCodeLine{61   \}}
\DoxyCodeLine{62   \textcolor{keywordflow}{return} \mbox{\hyperlink{s2n_2pq-crypto_2bike__r1_2error_8h_aa90cac659d18e8ef6294c7ae337f6b58}{SUCCESS}};}
\DoxyCodeLine{63 \}}
\DoxyCodeLine{64 }
\DoxyCodeLine{65 \mbox{\hyperlink{bike__r1_2defs_8h_ad320c6003c1b51d78cb343e674b9432f}{\_INLINE\_}} \textcolor{keywordtype}{void}}
\DoxyCodeLine{66 \mbox{\hyperlink{bike__r1_2aes__wrap_8h_a1b4eab7c1996aded95a9956093e31bf6}{aes256\_free\_ks}}(\mbox{\hyperlink{bike__r1__kem_8h_aec78e7a9e90a406a56f859ee456e8eae}{OUT}} \mbox{\hyperlink{bike__r1_2aes_8h_a02339f74806faf073c6ece7ddc667c7a}{aes256\_ks\_t}} *ks)}
\DoxyCodeLine{67 \{}
\DoxyCodeLine{68   EVP\_CIPHER\_CTX\_free(*ks);}
\DoxyCodeLine{69   *ks = \mbox{\hyperlink{namespace_aws_a41b67e809416e9bd96026fa1f414925d}{NULL}};}
\DoxyCodeLine{70 \}}
