\hypertarget{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md315}{}\doxysubsubsection{Design}\label{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md315}
...
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md316}{}\doxysubsubsection{Dep tree}\label{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md316}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md317}{}\doxysubsection{Usage to setup Projects}\label{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md317}
...
The broken out batch jobs\+: fuzz, integration and general, are created with the script create\+\_\+batch.\+sh, which uses jq to parse out the jobs by title.\hypertarget{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md320}{}\doxysubsection{Notes on moving from Travis-\/ci}\label{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md320}
...
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md321}{}\doxysubsection{Querying Code\+Build projects}\label{md_crt_aws_crt_cpp_crt_s2n_codebuild__r_e_a_d_m_e_autotoc_md321}
