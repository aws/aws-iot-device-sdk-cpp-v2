...
\DoxyCodeLine{53 \};}
\DoxyCodeLine{54 }
\DoxyCodeLine{55 \textcolor{keyword}{extern} \textcolor{keyword}{struct }\mbox{\hyperlink{structs2n__ticket__key}{s2n\_ticket\_key}} *\mbox{\hyperlink{s2n__resume_8h_a0a36aec54bd8a88ea460a3168531624c}{s2n\_find\_ticket\_key}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structs2n__config}{s2n\_config}} *\mbox{\hyperlink{namespacecreate__project_ab7f741ca784276a3f80325a8fb79fd95}{config}}, \textcolor{keyword}{const} uint8\_t *\mbox{\hyperlink{aws-c-iot_2include_2aws_2iotdevice_2external_2c_j_s_o_n_8h_a25d22ecc7e656d2c59332072684e8766}{name}});}
...
\DoxyCodeLine{61 \textcolor{keyword}{extern} \textcolor{keywordtype}{int} \mbox{\hyperlink{s2n__resume_8h_a405456e8d83a522fdf9c117b4e78ae23}{s2n\_verify\_unique\_ticket\_key}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structs2n__config}{s2n\_config}} *\mbox{\hyperlink{namespacecreate__project_ab7f741ca784276a3f80325a8fb79fd95}{config}}, uint8\_t *hash, uint16\_t *insert\_index);}
\DoxyCodeLine{62 \textcolor{keyword}{extern} \textcolor{keywordtype}{int} \mbox{\hyperlink{s2n__resume_8h_a2b2d20ed8363aa84eaa570e8151bbcdc}{s2n\_config\_wipe\_expired\_ticket\_crypto\_keys}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structs2n__config}{s2n\_config}} *\mbox{\hyperlink{namespacecreate__project_ab7f741ca784276a3f80325a8fb79fd95}{config}}, int8\_t expired\_key\_index);}
\DoxyCodeLine{63 \textcolor{keyword}{extern} \textcolor{keywordtype}{int} \mbox{\hyperlink{s2n__resume_8h_a919cfa25f29ca5d1437661531d6ac264}{s2n\_config\_store\_ticket\_key}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structs2n__config}{s2n\_config}} *\mbox{\hyperlink{namespacecreate__project_ab7f741ca784276a3f80325a8fb79fd95}{config}}, \textcolor{keyword}{struct} \mbox{\hyperlink{structs2n__ticket__key}{s2n\_ticket\_key}} *key);}
\DoxyCodeLine{64 }
