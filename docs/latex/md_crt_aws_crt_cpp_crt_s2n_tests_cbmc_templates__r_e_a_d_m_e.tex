...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_s2n_tests_cbmc_templates__r_e_a_d_m_e_autotoc_md523}{}\doxysection{Proof set up}\label{md_crt_aws_crt_cpp_crt_s2n_tests_cbmc_templates__r_e_a_d_m_e_autotoc_md523}
...
You can cut and paste into the files, and type {\ttfamily make} to run and debug the proof. For more details, see the instructions in the trainingmaterials repository\char`\"{}.  @section autotoc\+\_\+md524 Security  \+See $<$a href=\char`\"{}CONTRIBUTING.\+md\+::security-\/issue-\/notifications"{} \texorpdfstring{$>$}{>}CONTRIBUTING for more information.\hypertarget{md_crt_aws_crt_cpp_crt_s2n_tests_cbmc_templates__r_e_a_d_m_e_autotoc_md525}{}\doxysection{License}\label{md_crt_aws_crt_cpp_crt_s2n_tests_cbmc_templates__r_e_a_d_m_e_autotoc_md525}
