...
\DoxyCodeLine{61     \mbox{\hyperlink{client__impl_8h_a4ec959b94fcce2a80fe15e2fffd13c74}{aws\_mqtt\_send\_request\_fn}})(uint16\_t \mbox{\hyperlink{connection__state__test_8c_ad051e090f3817f4549df7dc178790f45}{packet\_id}}, \textcolor{keywordtype}{bool} is\_first\_attempt, \textcolor{keywordtype}{void} *userdata);}
\DoxyCodeLine{62 }
...
\DoxyCodeLine{103     \} \mbox{\hyperlink{structsubscribe__task__arg_a06a8c57447fd1d9c6e8fc8e3f163bb1b}{on\_suback}};}
...
\DoxyCodeLine{146     \} \mbox{\hyperlink{structaws__mqtt__client__connection_a5368c04d9c860b4cc1b5330002a9c910}{will}};}
...
\DoxyCodeLine{152     \} \mbox{\hyperlink{structaws__mqtt__client__connection_aab7687f322a9aab1bb06d52fbf7bc43b}{reconnect\_timeouts}};}
\DoxyCodeLine{153 }
...
\DoxyCodeLine{194     \} \mbox{\hyperlink{structaws__mqtt__client__connection_a2668e9e1cdabba439bc9fd6a956c40d4}{thread\_data}};}
\DoxyCodeLine{195 }
...
\DoxyCodeLine{220     \} \mbox{\hyperlink{structaws__mqtt__client__connection_a1533c01f7268b9f8fb10e212016d0b8a}{synced\_data}};}
\DoxyCodeLine{221 }
...
\DoxyCodeLine{234         \} * \mbox{\hyperlink{structaws__mqtt__client__connection_a3db1b509e516cdb9840c704490a063c2}{proxy}};}
...
\DoxyCodeLine{238     \} \mbox{\hyperlink{structaws__mqtt__client__connection_af1bb8d8602d74ec77b5ab36a225df031}{websocket}};}
\DoxyCodeLine{239 \};}
\DoxyCodeLine{240 }
...
\DoxyCodeLine{254     \textcolor{keyword}{enum} \mbox{\hyperlink{client__impl_8h_a5b3dcf5fc8697c535838cedfc1b171a7}{aws\_mqtt\_client\_connection\_state}} \mbox{\hyperlink{structstate}{state}});}
\DoxyCodeLine{255 }
...
\DoxyCodeLine{273     \textcolor{keywordtype}{int} \mbox{\hyperlink{channel__handler__test_8c_a7d16b1c68c87cec009d972e79abfba78}{error\_code}},}
\DoxyCodeLine{274     uint16\_t \mbox{\hyperlink{connection__state__test_8c_ad051e090f3817f4549df7dc178790f45}{packet\_id}});}
\DoxyCodeLine{275 }
