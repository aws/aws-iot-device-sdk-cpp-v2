C99 implementation of the MQTT 3.\+1.\+1 specification.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md300}{}\doxysection{License}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md300}
This library is licensed under the Apache 2.\+0 License.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md301}{}\doxysection{Usage}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md301}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md302}{}\doxysubsection{Building}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md302}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md303}{}\doxysubsubsection{Building s2n (\+Linux Only)}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md303}
...
\end{DoxyCode}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md304}{}\doxysubsubsection{Building aws-\/c-\/mqtt and Remaining Dependencies}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md304}
...
\end{DoxyCode}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md305}{}\doxysubsection{Overview}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md305}
This library contains an MQTT implementation that is simple and easy to use, but also quite powerful and low on unnecessary copies. Here is a general overview of the API\+:\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md306}{}\doxysubsection{$<$tt$>$struct aws\+\_\+mqtt\+\_\+client;$<$/tt$>$}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md306}
...
\DoxyCodeLine{    \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__allocator}{aws\_allocator}} *allocator,}
...
{\bfseries{NOTE}}\+: DO NOT CALL THIS FUNCTION UNTIL ALL OUTSTANDING CONNECTIONS ARE CLOSED.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md307}{}\doxysubsection{$<$tt$>$struct aws\+\_\+mqtt\+\_\+client\+\_\+connection;$<$/tt$>$}\label{md_crt_aws_crt_cpp_crt_aws_c_mqtt__r_e_a_d_m_e_autotoc_md307}
...
\DoxyCodeLine{    \textcolor{keyword}{const} \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__byte__cursor}{aws\_byte\_cursor}} *\mbox{\hyperlink{structaws__mqtt__client__connection_a8beb4d40f151fdeb2f630cfebeac924e}{topic}},}
\DoxyCodeLine{    \textcolor{keyword}{enum} \mbox{\hyperlink{mqtt_8h_a9c8e7e4cfbb7dcb3fc4a5402000998ce}{aws\_mqtt\_qos}} \mbox{\hyperlink{structaws__mqtt__client__connection_a5d116e4c37220a9397199e27e90b8bba}{qos}},}
...
\DoxyCodeLine{    \textcolor{keyword}{const} \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__byte__cursor}{aws\_byte\_cursor}} *\mbox{\hyperlink{structaws__mqtt__client__connection_ae79a30c3c428a546b220b93553ec3a75}{payload}});}
...
\DoxyCodeLine{    \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__mqtt__client__connection}{aws\_mqtt\_client\_connection}} *connection,}
\DoxyCodeLine{    \textcolor{keyword}{const} \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__byte__cursor}{aws\_byte\_cursor}} *\mbox{\hyperlink{structaws__mqtt__client__connection_aeaaf60b787337e2d69db65a5e9f51f1d}{username}},}
\DoxyCodeLine{    \textcolor{keyword}{const} \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__byte__cursor}{aws\_byte\_cursor}} *\mbox{\hyperlink{structaws__mqtt__client__connection_a87b9ffc0a328a668199840189e1f8e6a}{password}});}
...
\DoxyCodeLine{    \textcolor{keyword}{enum} \mbox{\hyperlink{mqtt_8h_a9c8e7e4cfbb7dcb3fc4a5402000998ce}{aws\_mqtt\_qos}} \mbox{\hyperlink{structaws__mqtt__client__connection_a5d116e4c37220a9397199e27e90b8bba}{qos}},}
\DoxyCodeLine{    \mbox{\hyperlink{client_8h_a979def98388f4a6c7eb7de0c3c868555}{aws\_mqtt\_client\_publish\_received\_fn}} *on\_publish,}
