...
\end{DoxyItemize}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__p_l_a_n_n_i_n_g_autotoc_md158}{}\doxysection{How to select what proofs to attempt, in what order}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__p_l_a_n_n_i_n_g_autotoc_md158}
...
\end{DoxyEnumerate}\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__p_l_a_n_n_i_n_g_autotoc_md159}{}\doxysection{How to get a sense of the work CBMC will involve}\label{md_crt_aws_crt_cpp_crt_aws_c_common_verification_cbmc_templates_training_material__p_l_a_n_n_i_n_g_autotoc_md159}
