...
\DoxyCodeLine{80 \textcolor{keyword}{typedef} \mbox{\hyperlink{preamble_8h_a37c756f466ee6aa44725fa95b55047cc}{pthread\_t}} \mbox{\hyperlink{thread_8h_a9ff84a0781fdcab710b0fa5e0a84d046}{aws\_thread\_id\_t}};}
...
\DoxyCodeLine{91     \textcolor{keyword}{struct }\mbox{\hyperlink{structaws__allocator}{aws\_allocator}} *\mbox{\hyperlink{structaws__thread_abd657b6ca4e93a315061c3abeda1c1e6}{allocator}};}
...
\DoxyCodeLine{114 \textcolor{keywordtype}{int} \mbox{\hyperlink{thread_8h_afd023fdb173f9f30b73c1a7836692169}{aws\_thread\_init}}(\textcolor{keyword}{struct} \mbox{\hyperlink{structaws__thread}{aws\_thread}} *thread, \textcolor{keyword}{struct} \mbox{\hyperlink{structaws__allocator}{aws\_allocator}} *\mbox{\hyperlink{socket__test_8c_a130cc941753892421e3f70bdee1049d1}{allocator}});}
\DoxyCodeLine{115 }
...
\DoxyCodeLine{190 }
\DoxyCodeLine{191 \textcolor{keyword}{typedef} void(\mbox{\hyperlink{thread_8h_ae015b53e5ea80a44f2c18e88df8645fd}{aws\_thread\_atexit\_fn}})(\textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{192 }
...
\DoxyCodeLine{200 \textcolor{keywordtype}{int} \mbox{\hyperlink{thread_8h_a086d801cf3c365e4b982c52637acf9b5}{aws\_thread\_current\_at\_exit}}(\mbox{\hyperlink{thread_8h_ae015b53e5ea80a44f2c18e88df8645fd}{aws\_thread\_atexit\_fn}} *callback, \textcolor{keywordtype}{void} *\mbox{\hyperlink{channel__handler__test_8c_af1abaca9a982b3cdb0b118914416c39b}{user\_data}});}
\DoxyCodeLine{201 }
