C99 library implementation of AWS client-\/side authentication\+: standard credentials providers and signing.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md41}{}\doxysection{License}\label{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md41}
This library is licensed under the Apache 2.\+0 License.\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md42}{}\doxysection{Usage}\label{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md42}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md43}{}\doxysubsection{Building}\label{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md43}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md44}{}\doxysubsubsection{Building s2n (\+Linux Only)}\label{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md44}
...
\end{DoxyCode}
\hypertarget{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md45}{}\doxysubsubsection{Building aws-\/c-\/auth and Remaining Dependencies}\label{md_crt_aws_crt_cpp_crt_aws_c_auth__r_e_a_d_m_e_autotoc_md45}
...
\DoxyCodeLine{}
\DoxyCodeLine{git clone git@github.com:awslabs/aws-\/c-\/auth.git}
\DoxyCodeLine{cmake -\/DCMAKE\_PREFIX\_PATH=<install-\/path> -\/DCMAKE\_INSTALL\_PREFIX=<install-\/path> -\/S aws-\/c-\/auth -\/B aws-\/c-\/auth/build}
\DoxyCodeLine{cmake -\/-\/build aws-\/c-\/auth/build -\/-\/target install}
