...
namespace Aws
{
    ...
    namespace Eventstreamrpc
    {
         ...
         */
        using OnDisconnect = std::function<void(const std::shared_ptr<EventstreamRpcConnection> &newConnection, int errorCode)>;

        using OnError = std::function<bool(int errorCode)>;

        using OnPing = std::function<void(const Crt::List<EventStreamHeader>& headers, const Crt::Optional<Crt::ByteBuf>& payload)>;
        ...
        class AWS_EVENTSTREAMRPC_API MessageAmendment final
        {
            public:
                ...
                MessageAmendment(const Crt::List<EventStreamHeader>& headers, Crt::Optional<Crt::ByteBuf>& payload) noexcept;
        ...
        class AWS_EVENTSTREAMRPC_API EventstreamRpcConnection : public std::enable_shared_from_this<EventstreamRpcConnection>
        {
            public:
